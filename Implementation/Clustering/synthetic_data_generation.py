...
def generate_synthetic_po2_maps():
    ...
    n_per_cmro2 = 150              # number of samples per cmro2 value (150 * 3 = 75 total)
    ...
    for i, cmro2_value in enumerate(bank_cmro2):
        ...
        bank_Rves_pertubated    = Rves_true + np.random.normal(0, pvessel_uncertainty, size=n_per_cmro2)
