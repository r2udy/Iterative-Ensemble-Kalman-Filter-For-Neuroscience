    ...
    def setup_problem(self, params, holes):
        ...
        for hole in holes:
            ...
            for i, hole in enumerate(holes):
                ...
                self.M_func.x.array[hole_dofs] = self.params.M # self.params.M * self.uh / (self.uh + self.params.p50)
...
class SolverParameters:
    ...
    def __init__(self, filename, cmro2, Pves, p50, Rves, R0, marker=3):
...
def main():
    ...
    params = SolverParameters(filename="square_one_hole_MM", cmro2=-1., Pves=75., p50=5., Rves=10., R0=80.)
